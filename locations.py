...
location_types: Mapping[str, LocationType] = {
    ...
    "npc_gift_pichu": LocationType(
        is_enabled = lambda opts : opts.npc_gifts.value == 1 and opts.randomize_encounters.value == 1,
        should_be_added = lambda opts : opts.randomize_encounters.value == 1,
    ),
